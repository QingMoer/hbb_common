...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("123321".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["kong.qingmoer.com"];
pub const RS_PUB_KEY: &str = "mUu96IRI87HPqEQAvXeJOVZ+g8cc6dxEv+5WnHI9gD8=";
